...
import vues.Recherche_Quizz.ButtonHolder;
import vues.Recherche_Quizz.ListCustomAdapter;
...
/**
 * permet d'effectuer des recherches des graphèmes qui sont livrés avec l'application
 * le clic sur un grapheme redirige vers la vue de quizz
 * @author Ammoula
 *
 */
public class Recherche_Quizz extends Activity implements TextWatcher{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.consulter_grapheme); //elle aura la même structure que consulter_grapheme seul la liste de grapheme qui change
...
public void onBackPressed(){
	...
	private void remplirListeModules() {
		// TODO Auto-generated method stub
	        ...
	        modulebdd.open();
	        //on remplie une liste par la liste des graphemes de dicionnaire
	        ArrayList<String> listeGraphemeModule=modulebdd.getListeModulesEleve("dictionnaire");
	        if(listeGraphemeModule!=null){
	        ListCustomAdapter listModuleAdapter  = new ListCustomAdapter(Recherche_Quizz.this, R.layout.element_list_bouton, listeGraphemeModule);
	        listeModuleView =(ListView) findViewById(R.id.listModule);
	...
	public void afterTextChanged(Editable arg0) {
        ...
        this.MapGraphemes=modulebdd.getGraphemesEleve(achercher.toUpperCase()+"%","dictionnaire" );
	...
	private void activerBoutonChercher() {
		...
		this.boutonChercher.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				String mot=Recherche_Quizz.this.grapheme.getText().toString();
				if(mot.compareTo("")==0)
					 {
						AlertFalse alert=new AlertFalse(Recherche_Quizz.this,"graphème vide !");//Enregistrer_Photo.this);
						alert.show();
					...
					//et on redirige vers la vue de consultation de tout le module
					 ...
					 ModulesBDD modulebdd = new ModulesBDD(Recherche_Quizz.this);
				     modulebdd.open();
				     String idEleve="dictionnaire";
				     ...
				     if(moduleTrouver==null)
						     {
						    	 AlertFalse alert=new AlertFalse(Recherche_Quizz.this,"module introuvable !");
						    	 alert.show();
						     }
				     else{
				    	//on charge le module courant par celui récupéré de la BD
							...
							//Toast.makeText(Recherche_Quizz.this,""+MainActivity.moduleCourant.ToString()+"", Toast.LENGTH_LONG).show();
							//on ridirige vers l'activity de consultation module
							Intent i;
				            i= new Intent(Recherche_Quizz.this,Quizz.class);
				            startActivity(i);
 ...
 */
		 ...
		 //on actionne les boutons 
		  holder.butonGrapheme.setOnClickListener(new View.OnClickListener() {
		   ...
		   public void onClick(View v) {
			...
			//Toast.makeText(Recherche_Quizz.this,""+mot+"", Toast.LENGTH_LONG).show();
				ModulesBDD modulebdd = new ModulesBDD(Recherche_Quizz.this);
			    modulebdd.open();
			    String idEleve="dictionnaire";
				//on recupère le module correspondant au grapheme saisi s'il en existe
			    ...
			    if(moduleTrouver==null)
					     {
					    	 AlertFalse alert=new AlertFalse(Recherche_Quizz.this,"graphème introuvable !");
					    	 alert.show();
					     }
			     else{
			    	//on charge le module courant par celui récupéré de la BD
						...
						MainActivity.moduleCourant=moduleTrouver;
						//Toast.makeText(Recherche_Quizz.this,""+MainActivity.moduleCourant.ToString()+"", Toast.LENGTH_LONG).show();
						//on ridirige vers l'activity Quizz
						Intent i;
			            i= new Intent(Recherche_Quizz.this,Quizz.class);
			            startActivity(i);
	...
	public void actionnerBoutonMenu(){
		...
		profil.setOnClickListener(new BoutonMenuListener (Modif_profil.class));
	...
	private class BoutonMenuListener implements View.OnClickListener{
		...
		public void onClick(View v) {
	    	...
	    	Intent i;
            i= new Intent(Recherche_Quizz.this,C);
            startActivity(i);
	    }
