...
public class BDCahierDeSon extends SQLiteOpenHelper {
	...
	//requete pour créer la table module
    ...
    //constructeur , creation de la base de données
    ...
    // à la création de tables de la base de données
	...
	public void onCreate(SQLiteDatabase db) {
		...
		try {
              ...
              db.execSQL(this.QUERY_CREATE_ELEVES);   //execution des requêtes creation eleves
              db.execSQL(this.QUERY_CREATE_MODULES); //  ---      ------     ------     modules
             // System.out.println("BDD sqlite");
              
            Log.i("BDD sqlite", "Création réussi");
            //Log.i("strucure", msg)
             
        } catch (Exception ex) {
          ex.printStackTrace();
          Log.i("BDD sqlite", "Création échouée");
        }	
